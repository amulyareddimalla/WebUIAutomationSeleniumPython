...
def setup(request):
    ...
    if browser_name == "chrome":
        ...
        driver = webdriver.Chrome(options=options, service=Service("C:/Users/amuly/PycharmProjects1/WebUIAutomation/Drivers/chromedriver.exe"))
        driver.maximize_window()
    elif browser_name == "edge":
        # Set the path to the Edge webdriver executable file
        edge_driver_path = r"C:/Users/amuly/PycharmProjects1/WebUIAutomation/Drivers/msedgedriver.exe"
...
def pytest_configure(config):
    config._metadata['Project Name'] = 'DemoQA WebUI Automation'
